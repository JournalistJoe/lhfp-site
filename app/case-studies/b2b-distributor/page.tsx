          ...
          >
            ...
            >
              <div className="flex items-center gap-2 px-4 py-2 bg-stream-blue/20 rounded-full border border-stream-blue/30">
                ...
                <span className="text-sm text-sage-300">80% Time Reduction</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-stream-blue/20 rounded-full border border-stream-blue/30">
                <ChartLineUp size={16} className="text-casting-green" />
                <span className="text-sm text-sage-300">3x Order Capacity</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-stream-blue/20 rounded-full border border-stream-blue/30">
                <CheckCircle size={16} className="text-casting-green" />
                <span className="text-sm text-sage-300">99.8% Accuracy</span>
              </div>
            </motion.div>
          </motion.variants>
        </div>
