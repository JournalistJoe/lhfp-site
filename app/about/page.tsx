    ...
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-10 dark:opacity-20">
          <div className="bg-stream-blue/20 absolute top-1/3 right-1/4 h-96 w-96 animate-pulse rounded-full blur-3xl" />
      ...
      <section className="relative px-4 pb-24 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            <h2 className="text-morning-mist dark:text-terminal-text mb-4 text-3xl font-bold">
              What We Stand For
            </h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {values.map((value, index) => (
              <div
                key={value.title}
                className="dark:bg-dark-card/80 dark:ring-dark-border group rounded-xl bg-white/90 p-6 backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl dark:ring-1"
                style={{
